...
_PIPELINEREFERENCE.fields_by_name['context'].message_type = pipeline__service__pb2._SESSIONCONTEXT
...
PipelineReference = _reflection.GeneratedProtocolMessageType('PipelineReference', (_message.Message,), dict(
  ...
  __module__ = 'dataflow_service_pb2'
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z\010dataflow'))
try:
  ...
  class BetaDataflowServicer(object):
  ...
  def beta_create_Dataflow_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    """The Beta API is deprecated for 0.15.0 and later.
    ...
    request_deserializers = {
      ('Dataflow', 'DescribeDataflow'): PipelineReference.FromString,
      ('Dataflow', 'GetDataflowResults'): PipelineReference.FromString,
    }
    response_serializers = {
      ('Dataflow', 'DescribeDataflow'): DataflowDescription.SerializeToString,
      ('Dataflow', 'GetDataflowResults'): ModuleResult.SerializeToString,
    }
    method_implementations = {
      ('Dataflow', 'DescribeDataflow'): face_utilities.unary_unary_inline(servicer.DescribeDataflow),
      ('Dataflow', 'GetDataflowResults'): face_utilities.unary_stream_inline(servicer.GetDataflowResults),
    }
    server_options = beta_implementations.server_options(request_deserializers=request_deserializers, response_serializers=response_serializers, thread_pool=pool, thread_pool_size=pool_size, default_timeout=default_timeout, maximum_timeout=maximum_timeout)
    return beta_implementations.server(method_implementations, options=server_options)


  def beta_create_Dataflow_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    """The Beta API is deprecated for 0.15.0 and later.
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('Dataflow', 'DescribeDataflow'): PipelineReference.SerializeToString,
      ('Dataflow', 'GetDataflowResults'): PipelineReference.SerializeToString,
    }
    response_deserializers = {
      ('Dataflow', 'DescribeDataflow'): DataflowDescription.FromString,
      ('Dataflow', 'GetDataflowResults'): ModuleResult.FromString,
    }
    cardinalities = {
    ...
    return beta_implementations.dynamic_stub(channel, 'Dataflow', cardinalities, options=stub_options)
except ImportError:
  pass
