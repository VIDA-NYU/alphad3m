...
from . import pipeline_data_pb2 as pipeline__data__pb2
...
class PipelineDataStub(object):
  ...
  def __init__(self, channel):
    ...
    self.AddFeatures = channel.unary_unary(
        ...
        request_serializer=pipeline__data__pb2.AddFeaturesRequest.SerializeToString,
    ...
    self.RemoveFeatures = channel.unary_unary(
        ...
        request_serializer=pipeline__data__pb2.RemoveFeaturesRequest.SerializeToString,
        response_deserializer=pipeline__service__pb2.Response.FromString,
        )
    self.AddSamples = channel.unary_unary(
        '/PipelineData/AddSamples',
        request_serializer=pipeline__data__pb2.AddSamplesRequest.SerializeToString,
        response_deserializer=pipeline__service__pb2.Response.FromString,
        )
    self.RemoveSamples = channel.unary_unary(
        '/PipelineData/RemoveSamples',
        request_serializer=pipeline__data__pb2.RemoveSamplesRequest.SerializeToString,
        response_deserializer=pipeline__service__pb2.Response.FromString,
        )
    self.ReplaceData = channel.unary_unary(
        '/PipelineData/ReplaceData',
        request_serializer=pipeline__data__pb2.ReplaceDataRequest.SerializeToString,
        response_deserializer=pipeline__service__pb2.Response.FromString,
        )
    self.Materialize = channel.unary_unary(
        '/PipelineData/Materialize',
        request_serializer=pipeline__data__pb2.MaterializeRequest.SerializeToString,
        response_deserializer=pipeline__service__pb2.Response.FromString,
        )
    self.TrainValidationSplit = channel.unary_unary(
        '/PipelineData/TrainValidationSplit',
        request_serializer=pipeline__data__pb2.TrainValidationSplitRequest.SerializeToString,
        response_deserializer=pipeline__service__pb2.Response.FromString,
        )
    self.Revert = channel.unary_unary(
        '/PipelineData/Revert',
        request_serializer=pipeline__data__pb2.RevertRequest.SerializeToString,
        response_deserializer=pipeline__service__pb2.Response.FromString,
        )
...
def add_PipelineDataServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'AddFeatures': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=pipeline__data__pb2.AddFeaturesRequest.FromString,
      ...
      'RemoveFeatures': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=pipeline__data__pb2.RemoveFeaturesRequest.FromString,
          response_serializer=pipeline__service__pb2.Response.SerializeToString,
      ),
      'AddSamples': grpc.unary_unary_rpc_method_handler(
          servicer.AddSamples,
          request_deserializer=pipeline__data__pb2.AddSamplesRequest.FromString,
          response_serializer=pipeline__service__pb2.Response.SerializeToString,
      ),
      'RemoveSamples': grpc.unary_unary_rpc_method_handler(
          servicer.RemoveSamples,
          request_deserializer=pipeline__data__pb2.RemoveSamplesRequest.FromString,
          response_serializer=pipeline__service__pb2.Response.SerializeToString,
      ),
      'ReplaceData': grpc.unary_unary_rpc_method_handler(
          servicer.ReplaceData,
          request_deserializer=pipeline__data__pb2.ReplaceDataRequest.FromString,
          response_serializer=pipeline__service__pb2.Response.SerializeToString,
      ),
      'Materialize': grpc.unary_unary_rpc_method_handler(
          servicer.Materialize,
          request_deserializer=pipeline__data__pb2.MaterializeRequest.FromString,
          response_serializer=pipeline__service__pb2.Response.SerializeToString,
      ),
      'TrainValidationSplit': grpc.unary_unary_rpc_method_handler(
          servicer.TrainValidationSplit,
          request_deserializer=pipeline__data__pb2.TrainValidationSplitRequest.FromString,
          response_serializer=pipeline__service__pb2.Response.SerializeToString,
      ),
      'Revert': grpc.unary_unary_rpc_method_handler(
          servicer.Revert,
          request_deserializer=pipeline__data__pb2.RevertRequest.FromString,
          response_serializer=pipeline__service__pb2.Response.SerializeToString,
      ),
  }
